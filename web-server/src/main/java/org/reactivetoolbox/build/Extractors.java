...
public interface Extractors {
    interface E1<T1> extends FN1<Either<? extends BaseError, Tuple1<T1>>, P<T1>> { }
    interface E2<T1, T2> extends FN2<Either<? extends BaseError, Tuple2<T1, T2>>, P<T1>, P<T2>> { }
    interface E3<T1, T2, T3> extends FN3<Either<? extends BaseError, Tuple3<T1, T2, T3>>, P<T1>, P<T2>, P<T3>> { }
    interface E4<T1, T2, T3, T4> extends FN4<Either<? extends BaseError, Tuple4<T1, T2, T3, T4>>, P<T1>, P<T2>, P<T3>, P<T4>> { }
    interface E5<T1, T2, T3, T4, T5> extends FN5<Either<? extends BaseError, Tuple5<T1, T2, T3, T4, T5>>, P<T1>, P<T2>, P<T3>, P<T4>, P<T5>> { }
    interface E6<T1, T2, T3, T4, T5, T6> extends FN6<Either<? extends BaseError, Tuple6<T1, T2, T3, T4, T5, T6>>, P<T1>, P<T2>, P<T3>, P<T4>, P<T5>, P<T6>> { }
    interface E7<T1, T2, T3, T4, T5, T6, T7> extends FN7<Either<? extends BaseError, Tuple7<T1, T2, T3, T4, T5, T6, T7>>, P<T1>, P<T2>, P<T3>, P<T4>, P<T5>, P<T6>, P<T7>> { }
    interface E8<T1, T2, T3, T4, T5, T6, T7, T8> extends FN8<Either<? extends BaseError, Tuple8<T1, T2, T3, T4, T5, T6, T7, T8>>, P<T1>, P<T2>, P<T3>, P<T4>, P<T5>, P<T6>, P<T7>, P<T8>> { }
    interface E9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends FN9<Either<? extends BaseError, Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>>, P<T1>, P<T2>, P<T3>, P<T4>, P<T5>, P<T6>, P<T7>, P<T8>, P<T9>> { }


    static <T1> E1<T1> extract1(final RequestContext context) {
    ...
    static <T1, T2, T3> E3<T1, T2, T3> extract3(final RequestContext context) {
        return (v1, v2, v3) -> zip(v1.converter().apply(context),
                                   v2.converter().apply(context),
                                   v3.converter().apply(context));
    }

    static <T1, T2, T3, T4> E4<T1, T2, T3, T4> extract4(final RequestContext context) {
    ...
    static <T1, T2, T3, T4, T5> E5<T1, T2, T3, T4, T5> extract5(final RequestContext context) {
    ...
    static <T1, T2, T3, T4, T5, T6> E6<T1, T2, T3, T4, T5, T6> extract6(final RequestContext context) {
    ...
    static <T1, T2, T3, T4, T5, T6, T7> E7<T1, T2, T3, T4, T5, T6, T7> extract7(final RequestContext context) {
    ...
    static <T1, T2, T3, T4, T5, T6, T7, T8> E8<T1, T2, T3, T4, T5, T6, T7, T8> extract8(final RequestContext context) {
    ...
    static <T1, T2, T3, T4, T5, T6, T7, T8, T9> E9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extract9(final RequestContext context) {
