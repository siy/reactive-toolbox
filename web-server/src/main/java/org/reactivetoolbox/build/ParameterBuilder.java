...
public class ParameterBuilder {
    public static ParameterBuilder0 of(final Path path) {
        return new ParameterBuilder0(path);
    }

    public static <T1> ParameterBuilder1<T1> of(final Path path,
                                                final Parameter<T1> param1) {
        return new ParameterBuilder1<>(path, param1);
    }

    public static <T1, T2> ParameterBuilder2<T1, T2> of(final Path path,
                                                        final Parameter<T1> param1,
                                                        final Parameter<T2> param2) {
        return new ParameterBuilder2<>(path, param1, param2);
    }
    ...
    public static <T1, T2, T3> ParameterBuilder3<T1, T2, T3> of(final Path path,
        ...
        return new ParameterBuilder3<>(path, param1, param2, param3);
    }
    ...
    public static <T1, T2, T3, T4> ParameterBuilder4<T1, T2, T3, T4> of(final Path path,
        ...
        return new ParameterBuilder4<>(path, param1, param2, param3, param4);
    }
    ...
    public static <T1, T2, T3, T4, T5> ParameterBuilder5<T1, T2, T3, T4, T5> of(final Path path,
        ...
        return new ParameterBuilder5<>(path, param1, param2, param3, param4, param5);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6> ParameterBuilder6<T1, T2, T3, T4, T5, T6> of(final Path path,
        ...
        return new ParameterBuilder6<>(path, param1, param2, param3, param4, param5,
                                       param6);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7> ParameterBuilder7<T1, T2, T3, T4, T5, T6, T7> of(
        ...
        return new ParameterBuilder7<>(path, param1, param2, param3, param4, param5, param6,
                                       param7);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> ParameterBuilder8<T1, T2, T3, T4, T5, T6, T7, T8> of(
        ...
        return new ParameterBuilder8<>(path, param1, param2, param3, param4, param5, param6,
                                       param7, param8);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9> ParameterBuilder9<T1, T2, T3, T4, T5, T6, T7, T8, T9> of(
        ...
        return new ParameterBuilder9<>(path, param1, param2, param3, param4, param5, param6,
    ...
    public static class ParameterBuilder0 {
        ...
        private ParameterBuilder0(final Path path) {
            this.path = path;
        }
    ...
    public static class ParameterBuilder1<T1> {
        ...
        private ParameterBuilder1(final Path path, final Parameter<T1> param1) {
            this.path = path;
            this.param1 = param1;
        }
