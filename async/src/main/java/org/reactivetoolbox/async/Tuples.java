...
import static org.reactivetoolbox.async.Functions.*;
...
public final class Tuples {
    ...
    public static class Tuple3<T1, T2, T3> extends Tuple {
        private Tuple3(T1 param1, T2 param2, T3 param3) {
    ...
    public static class Tuple4<T1, T2, T3, T4> extends Tuple {
        private Tuple4(T1 param1, T2 param2, T3 param3, T4 param4) {
    ...
    public static class Tuple5<T1, T2, T3, T4, T5> extends Tuple {
        private Tuple5(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5) {
    ...
    public static class Tuple6<T1, T2, T3, T4, T5, T6> extends Tuple {
        private Tuple6(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6) {
    ...
    public static class Tuple7<T1, T2, T3, T4, T5, T6, T7> extends Tuple {
        private Tuple7(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6, T7 param7) {
    ...
    public static class Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> extends Tuple {
        private Tuple8(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6, T7 param7, T8 param8) {
    ...
    public static class Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends Tuple {
        private Tuple9(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5, T6 param6, T7 param7, T8 param8, T9 param9) {
