...
/**
 * Parser for JSON into navigable internal representation suitable for further
 * processing into POJO's.
 * The implementation is heavily based on "Jsmn is a world fastest JSON parser/tokenizer." https://github.com/zserge/jsmn
 *
 * @implNote The code is heavily tuned to obtain maximal possible performance. As a consequence it far from clean or
 * easily readable. DO NOT TOUCH it unless you absolutely sure that you're clearly understand consequences.
 */
public class JsonRawParser {
                        ...
                        primitive: {
                            ...
                            for (; pos < js.length; pos++) {
                                switch (js[pos]) {
                                    ...
                                    default:
                                        //Covers also case of js[pos] < 0, i.e. second half of the ASCII table
                                        if (js[pos] < 32) {
                                            pos = start;
                                            return ErrorCode.ERR_INVALID;
                                        }
