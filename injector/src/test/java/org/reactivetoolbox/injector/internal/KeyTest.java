...
import org.reactivetoolbox.injector.internal.beans.ClassWithDefaultConstructor;
...
public class KeyTest {
    ...
    public void shouldCreateKeyForSimpleClass() throws Exception {
        ...
        assertThat(key.type().getTypeName()).isEqualTo("org.reactivetoolbox.injector.internal.beans.ClassWithDefaultConstructor");
        assertThat(key.toString()).isEqualTo("{org.reactivetoolbox.injector.internal.beans.ClassWithDefaultConstructor}");
    }
    ...
    public void shouldCreateKeyForSimpleClassWithAnnotation() throws Exception {
        ...
        assertThat(key.toString()).isEqualTo("{org.reactivetoolbox.injector.internal.beans.ClassWithDefaultConstructor @org.reactivetoolbox.injector.internal.KeyTest$TestAnnotation}");
    }
    ...
    public void shouldCreateKeyForTypeTokenWithAnnotation() throws Exception {
        ...
        assertThat(key.annotation()).isInstanceOf(TestAnnotation.class);
        assertThat(key.type().toString()).isEqualTo("java.util.List<java.util.function.Supplier<java.lang.String>>");
        assertThat(key.toString()).isEqualTo("{java.util.List<java.util.function.Supplier<java.lang.String>> @org.reactivetoolbox.injector.internal.KeyTest$TestAnnotation}");
    }
