...
final class Uring {
     ...
     *
     * @param domain
     *          Socket domain. Refer to {@link SocketDomain} for more details.
     * @param type
     *          Socket type and open flags. Refer to {@link SocketType} for possible types. The {@link SocketOpenFlag} flags can be OR-ed if necessary.
     * @param options
     *          Socket options. Only subset of possible options are supported. Refer to {@link SocketOption} for details.
