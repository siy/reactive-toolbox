...
/**
 * Tuple classes with various size and convenient static factories for tuples. All tuple classes
 * are immutable.
 * <br/>
 * The Tuple is a container for variables. Tuples with size 1 to 9 are provided. Each variable
...
public final class Tuples {
     ...
     * @return created tuple newInstance.
     */
    public static<T1, T2, T3, T4> Tuple4<T1, T2, T3, T4> of(final T1 param1, final T2 param2, final T3 param3, final T4 param4) {
     ...
     * @return created tuple newInstance.
     */
    public static<T1, T2, T3, T4, T5> Tuple5<T1, T2, T3, T4, T5> of(final T1 param1, final T2 param2, final T3 param3, final T4 param4, final T5 param5) {
     ...
     * @return created tuple newInstance.
     */
    public static<T1, T2, T3, T4, T5, T6> Tuple6<T1, T2, T3, T4, T5, T6> of(final T1 param1, final T2 param2, final T3 param3, final T4 param4, final T5 param5, final T6 param6) {
     ...
     * @return created tuple newInstance.
     */
    public static<T1, T2, T3, T4, T5, T6, T7> Tuple7<T1, T2, T3, T4, T5, T6, T7> of(final T1 param1, final T2 param2, final T3 param3, final T4 param4, final T5 param5, final T6 param6, final T7 param7) {
     ...
     * @return created tuple newInstance.
     */
    public static<T1, T2, T3, T4, T5, T6, T7, T8> Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> of(final T1 param1, final T2 param2, final T3 param3, final T4 param4, final T5 param5, final T6 param6, final T7 param7, final T8 param8) {
     ...
     * @return created tuple newInstance.
     */
    public static<T1, T2, T3, T4, T5, T6, T7, T8, T9> Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> of(final T1 param1, final T2 param2, final T3 param3, final T4 param4, final T5 param5, final T6 param6, final T7 param7, final T8 param8, final T9 param9) {
    ...
    public static class Tuple6<T1, T2, T3, T4, T5, T6> extends Tuple {
        private Tuple6(final T1 param1, final T2 param2, final T3 param3, final T4 param4, final T5 param5, final T6 param6) {
    ...
    public static class Tuple7<T1, T2, T3, T4, T5, T6, T7> extends Tuple {
        private Tuple7(final T1 param1, final T2 param2, final T3 param3, final T4 param4, final T5 param5, final T6 param6, final T7 param7) {
    ...
    public static class Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> extends Tuple {
        private Tuple8(final T1 param1, final T2 param2, final T3 param3, final T4 param4, final T5 param5, final T6 param6, final T7 param7, final T8 param8) {
    ...
    public static class Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends Tuple {
        private Tuple9(final T1 param1, final T2 param2, final T3 param3, final T4 param4, final T5 param5, final T6 param6, final T7 param7, final T8 param8, final T9 param9) {
