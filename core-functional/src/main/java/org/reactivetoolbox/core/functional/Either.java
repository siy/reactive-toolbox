...
/**
 * Convenience type for use in cases when function may return different types. For example, when either
 * execution result or error value can be returned.
 * By convention <code>right</code> value holds results of successful execution, while <code>left</code>
 * holds exception or error value.
 *
...
public final class Either<L, R> {
    ...
    /**
     * Similar to {@link #left()}, but enforces convention and returns an instance of {@link Either} for given <code>left</code> value.
     *
     * @param value right value
     * @param <L> type of left value
     * @param <R> type of right value
    ...
    /**
     * Similar to {@link #right()}, but enforces convention and returns an instance of {@link Either} for given <code>right</code> value.
     *
     * @param value right value
     * @param <L> type of left value
     * @param <R> type of right value
    ...
    /**
     * Wrap checked function into {@link Function} which returns {@link Either}.
     * This method enables convenient transformation of the exception into user defined type.
     *
     * @param function function to wrap
     * @param errorMapper function which transforms exception into user defined type
     * @param <T>      input value type
     * @param <R>      result value type
     * @return {@link Function} which returns {@link Either}
     */
    ...
    /**
     * Wrap checked function into {@link Function} which returns {@link Either}.
     * In contrast to {@link #lift(CheckedFunction)}, this function returns {@link Pair} which
     * holds exception and initial input value in case if exception was thrown.
     * This is suitable for cases when operation might need to be retried with initial input value.
     *
     * @param function function to wrap
     * @param <T>      input value type
